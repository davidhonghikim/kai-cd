...
*This document serves as the definitive specification for PromptTransformer engine architecture and implementation in the kAI and kOS ecosystem. All implementation details are preserved to ensure consistent development across multiple teams.* 